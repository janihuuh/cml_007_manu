...
## Smith et al Blood Adv 2020
smith_mark <- c("GZMB", "GZMK", "GNLY", "PRF1", "CTSW", "TIGIT", "KLRD1", "KLRB1", "LAIR1", "KLRC1", "TNFRF10", "FASLG", "FCGR3A", "NCR1", "NCR3", "KLRK1", "KLRC2", "CD226", "IFNG", "LTB", "CCL3", "CCL4", "CCL5", "XCL1", "XCL2", "IL7R", "IL2RB", "IL21R", "CXCR3", "CXCR4", "CCR7", "CXCR1", "S1PR5", "ITGAL", "CD2", "CD58", "ITGB2", "SELL", "CD96")
